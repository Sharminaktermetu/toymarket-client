...
const Steps = () => {
    return (
        <section className="bg-gray-100 py-16 mt-16 rounded">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Educational Toys</h3>
            <p className="text-gray-600">Explore our collection of educational toys that promote learning and creativity.</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Action Figures</h3>
            <p className="text-gray-600">Find your favorite action figures from popular movies, TV shows, and comics.</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Puzzles and Games</h3>
